...
const vec3 hemiLight_g_1 = vec3(0.8980392156862745,0.,0.3803921568627451);
const vec3 hemiLight_s_1 = vec3(0.9372549019607843,0.796078431372549,0.011764705882352941);
const vec3 hemiLight_g_2 = vec3(0.6352941176470588,0.043137254901960784,0.4745098039215686);
const vec3 hemiLight_s_2 = vec3(0.6352941176470588,0.043137254901960784,0.1411764705882353);
