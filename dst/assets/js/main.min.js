...
var Analyzer = (function () {
  ...
  _createClass(Analyzer, [{
    ...
    value: function calcFrequency(num, interval, i) {
      ...
      var targetFrequency = this.cubic(mu, p0, p1, p2, p3);
...
var Mask = (function () {
  ...
  _createClass(Mask, [{
    ...
    value: function createObj() {
      ...
      this.colorPallete = [new THREE.Color(0xd4ab06), new THREE.Color(0xf5c506), new THREE.Color(0xffd42a), new THREE.Color(0xc3a118)];
      ...
      for (var i = 0, len = nums.count; i < len; i++) {
        nums.setX(i, i);
        // console.log(i);
